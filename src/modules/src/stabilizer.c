...
/*
LOG_GROUP_START(hellotest)
LOG_ADD(LOG_FLOAT,pi,&hello)
LOG_GROUP_STOP(hellotest)*/

LOG_GROUP_START(eulerControl)
LOG_ADD(LOG_FLOAT,eroll,&Econtrol.roll)
LOG_ADD(LOG_FLOAT,epitch,&Econtrol.pitch)
LOG_ADD(LOG_FLOAT,eyaw,&Econtrol.yaw)
LOG_ADD(LOG_FLOAT,ethrust,&Econtrol.thrust)
LOG_GROUP_STOP(eulerControl)
