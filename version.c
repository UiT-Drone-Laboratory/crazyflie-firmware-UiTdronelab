...
const char * V_SLOCAL_REVISION="76";
const char * V_SREVISION="d315da094907";
const char * V_STAG="2020.02 +76";
...
const uint32_t V_REVISION_0=0xd315da09;
const uint16_t V_REVISION_1=0x4907;
